#!/usr/bin/env python3
"""
Script para enriquecimento COMPLETO de TODAS as fixtures com home_team_id e away_team_id
Processa TODAS as fixtures (incluindo as que já têm dados) usando chamadas de múltiplos IDs
"""
...
class AllFixturesTeamsEnrichment:
    """Classe para enriquecimento completo de TODAS as fixtures com IDs dos times"""
        ...
        try:
            ...
            for fixture_data in api_response['data']:
                ...
                if team_ids['home_team_id'] and team_ids['away_team_id']:
                    # Atualizar fixture (sempre, mesmo que já tenha dados)
...
""")
    ...
    def run_complete_enrichment(self):
        """Executar enriquecimento completo de TODAS as fixtures"""
        logger.info("🚀 Iniciando ENRIQUECIMENTO COMPLETO de TODAS as fixtures com team IDs...")
        logger.info("=" * 80)
...
def main():
    """Função principal"""
    try:
        enrichment = AllFixturesTeamsEnrichment()
        enrichment.run_complete_enrichment()
