#!/usr/bin/env python3
"""
Script para monitorar o progresso do enriquecimento de fixtures com team IDs
"""
...
class TeamsEnrichmentMonitor:
    """Monitor do enriquecimento de fixtures com team IDs"""
    ...
    def monitor_progress(self):
        ...
        logger.info("🔍 Iniciando monitoramento do enriquecimento de fixtures...")
        logger.info("=" * 70)
        ...
        while True:
            try:
                ...
                if stats:
                    ...
                    logger.info(f"""
📊 STATUS DO ENRIQUECIMENTO - {current_time.strftime('%H:%M:%S')}
======================================================================
...
def main():
    """Função principal"""
    try:
        monitor = TeamsEnrichmentMonitor()
