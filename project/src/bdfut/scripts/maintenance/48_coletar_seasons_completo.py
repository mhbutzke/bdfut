...
def collect_all_seasons() -> List[Dict[str, Any]]:
    """
    Coleta todos os seasons da Sportmonks API com paginação completa.
    """
    logger.info("=" * 80)
    logger.info("🚀 COLETANDO TODOS OS SEASONS DA SPORTMONKS API")
    logger.info("=" * 80)
    ...
    logger.info("📡 Iniciando coleta com paginação...")
    ...
    while page <= total_pages:
        try:
            ...
            logger.info(f"📊 Total de páginas: {total_pages}, Tem mais: {has_more}")
