#!/usr/bin/env python3
"""
PASSO 2: Coletar fixtures por temporada
Estratégia otimizada: buscar fixture IDs por season, depois detalhes em lotes
"""
import sys
import os
        ...
        for i in range(0, len(fixture_ids), batch_size):
            ...
            try:
                ...
                for fixture in fixtures_details:
                    try:
                        # Preparar dados da fixture
                        fixture_data = {
                            'sportmonks_id': fixture.get('id'),
                            'sport_id': fixture.get('sport_id', 1),
                            ...
                            'has_players_statistics': fixture.get('has_players_statistics', False),
                            'deleted': fixture.get('deleted', False),
                            'is_placeholder': fixture.get('is_placeholder', False),
...
def main():
    ...
    print("=" * 80)
    print("🎯 PASSO 2: COLETAR FIXTURES POR TEMPORADA")
    print("=" * 80)
