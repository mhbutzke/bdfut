...
def get_all_countries_with_pagination():
    ...
    try:
        ...
        while True:
            ...
            logger.info(f"📄 Fazendo requisição - Página {page} (per_page={per_page})")
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("🚀 COLETANDO TODOS OS COUNTRIES DA SPORTMONKS API COM PAGINAÇÃO")
    logger.info("=" * 80)
    
    # Coletar todos os countries com paginação
    ...
    if countries_data:
        ...
        logger.error("❌ Falha na coleta de countries")
